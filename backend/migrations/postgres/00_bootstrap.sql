...
CREATE UNIQUE INDEX IF NOT EXISTS uk_role_permission_active ON ty_role_permissions(role, permission_code) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_role_permissions_role_enabled ON ty_role_permissions(role, enabled) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_policy_rules_permission ON ty_policy_rules(permission_code) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_policy_rules_resource ON ty_policy_rules(resource_type) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_authz_decisions_created_at ON ty_authz_decisions(created_at DESC) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_authz_decisions_action_allowed ON ty_authz_decisions(action, allowed) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_authz_decisions_operator ON ty_authz_decisions(operator_id, operator_role) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_authz_decisions_resource ON ty_authz_decisions(resource_type, resource_id) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_authz_decisions_reason ON ty_authz_decisions(reason) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_authz_policy_changes_created_at ON ty_authz_policy_changes(created_at DESC) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_authz_policy_changes_type_target ON ty_authz_policy_changes(change_type, target_key) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_authz_policy_changes_operator ON ty_authz_policy_changes(operator_id, operator_role) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_authz_policy_changes_rollback_of_id ON ty_authz_policy_changes(rollback_of_id) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_authz_policy_change_requests_type_status ON ty_authz_policy_change_requests(request_type, status) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_authz_policy_change_requests_requested_by ON ty_authz_policy_change_requests(requested_by, requested_by_role) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_authz_policy_change_requests_target_key ON ty_authz_policy_change_requests(target_key) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_authz_policy_change_requests_created_at ON ty_authz_policy_change_requests(created_at DESC) WHERE deleted_at IS NULL;
